...
class GameView(arcade.View):
    def __init__(self):
        ...
        # Set up the player
        self.score = 0
        self.player_sprite = arcade.Sprite("AlMcWhiggin.png",#":resources:images/animated_characters/female_person/femalePerson_idle.png",
                                           SPRITE_SCALING)
        ...
        for i in range(5):
            ...
            coin = arcade.Sprite("cheese.png" , SPRITE_SCALING / 3)#":resources:images/items/coinGold.png"
